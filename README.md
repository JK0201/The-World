...
## Outro
  <details>
    ...
    <ul>
      <li>프로젝트를 진행하면서 프론트엔드, 백엔드, 배포, 그리고 서버 관리까지 전반적인 개발 단계를 개별적으로 경험할 수 있었습니다. 다양한 기술 스택을 공부하고 활용하여 문제를 해결하는 과정을 거치면서, 문제 식별 및 해결 능력이 크게 향상 되었고, 전체 시스템을 자체적으로 설계하고 구현할 수 있는 능력을 기르는데 큰 도움이 되었습니다.</li>
