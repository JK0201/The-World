...
## Overview
- The World는 "춘식이의 관찰일기"를 모티브로 개발된 3D 기반의 개인용 인터랙티브 포트폴리오 사이트입니다. ThreeJS를 활용해 웹상에서 생동감 있는 3D 모델을 렌더링하며, Spring과 JPA를 이용하여 서버를 구현했습니다. Docker를 사용한 배포 환경 구축과 CI/CD 파이프라인을 통한 자동 배포 설정을 완료했습니다. 해당 프로젝트의 주된 목표는 사용자가 사이트에 방문했을때 흥미로운 콘텐츠와 상호작용을 통해 더 오래 머물고자 하는 욕구를 자극하여, 사용자 경험을 극대화하고, 단순 전달을 넘어서 방문자에게 강렬한 인상을 남길 수 있는 포트폴리오를 만드는 것입니다.
<br>
