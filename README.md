...
## Outro
  <details>
    ...
    <ul>
      <li>ExceptionHandler를 사용해 예외 상황을 관리하는 법을 배울 수 있었습니다. 각 상황에 적합한 HTTP status code와 명확한 메시지를 서버에서 보내줌으로써, 개발하는 동안 문제의 원인을 쉽게 파악할 수 있었습니다. 또한 사용자에게 상황에 맞는 피드백을 제공해줌으로써 사용자 경험을 극대화할 수 있다는 점을 통해 전반적인 에러 처리의 중요성을 깨달았습니다.</li>
    </ul>
  </details>
<br>
