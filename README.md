...
## 주요 작업
  ...
  <details>
    ...
    <ul>
      <li>GitHub Actions를 사용하여 코드 변경 시 자동으로 빌드 및 배포되도록 각 계층별 Workflow를 작성하고 파이프라인 설정</li>
      <li>민감한 정보를 안전하게 관리하기 위해 Github Secrets를 사용하여 </li>
    </ul>
  </details>
...
## Outro
  <details>
    ...
    <ul>
      ...
      <li>Docker와 Github Actions를 사용하여 CI/CD 파이프라인을 구축하면서, 현대 개발 프로세스에서 DevOps의 중요성을 직접 경험할 수 있었습니다. 컨테이너를 활용해 각 서비스를 독립적으로 분리하고 관리함으로써, 시스템 전체의 안정성과 유지 관리가 향상되었습니다. 또한, Github Actions로 자동화된 Workflow</li>
    </ul>
  </details>
<br>
